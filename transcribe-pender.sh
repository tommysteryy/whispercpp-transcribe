...
inputFile="../curr_video_list_pender.txt"
...
while IFS= read -r -u 3 line; do
    ...
    # Check if the result starts with "Error"sc or "No file found", meaning it did not match a youtuber
    ...
    ./main-pender.sh -n "$line" -m "$model" -p "$youtuber"
done 3<"$inputFile"
